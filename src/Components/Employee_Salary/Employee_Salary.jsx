                ...
                <table className="min-w-full bg-white font-[sans-serif]">
                    ...
                    <tbody className="whitespace-nowrap">
                        ...
                        <tr className="odd:bg-blue-50">
                            ...
                            <td className="px-6 py-3 text-sm">
                                <div className="flex items-center cursor-pointer">
                                    <img src='https://readymadeui.com/profile_5.webp' className="w-9 h-9 rounded-full shrink-0" />
                                    <div className="ml-4">
                        ...
                        <tr className="odd:bg-blue-50">
                            ...
                            <td className="px-6 py-3 text-sm">
                                <div className="flex items-center cursor-pointer">
                                    <img src='https://readymadeui.com/profile_3.webp' className="w-9 h-9 rounded-full shrink-0" />
                                    <div className="ml-4">
